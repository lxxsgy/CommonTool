...
{g.accordion.height(height);height-=g.headerHoldHeight;}};g.accordion=$(this);if(!g.accordion.hasClass("l-accordion-panel"))g.accordion.addClass("l-accordion-panel");var selectedIndex=0;if($("> div[lselected=true]",g.accordion).length>0)
...
{var newheight=g.tab.height();contentitem.height(newheight);}
...
{var newheight=g.tab.height();g.tab.content.height(newheight);$("> .l-tab-content-item",g.tab.content).height(newheight);},getNewTabid:function()
